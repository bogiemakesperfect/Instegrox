...
Future<UserSearchsonuc> getUserSearch(String deger) async {
  var i_d = "";
            ...
            var url = Uri.parse('https://i.instagram.com/api/v1/users/search/?query=$deger');
            ...
            return UserSearchsonuc.fromJson(jsonDecode(response.body));
          } 