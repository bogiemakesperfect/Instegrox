...
class User {
    ...
    factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        hdProfilePicVersions: json["hd_profile_pic_versions"]== null ? null : List<HdProfilePic>.from(json["hd_profile_pic_versions"].map((x) => HdProfilePic.fromJson(x))),
        hdProfilePicUrlInfo: json["hd_profile_pic_url_info"] == null ? null : HdProfilePic.fromJson(json["hd_profile_pic_url_info"]) ,
        ...
        creatorShoppingInfo: json["creator_shopping_info"] == null ? null : CreatorShoppingInfo.fromJson(json["creator_shopping_info"]),
        ...
        bioLinks: json["bio_links"] == null ? null : List<dynamic>.from(json["bio_links"].map((x) => x)),
        ...
        pronouns:  json["pronouns"] == null ? null : List<dynamic>.from(json["pronouns"].map((x) => x)),
