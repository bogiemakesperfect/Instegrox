...
class EnAzYorumYapipBegenenlerPage extends StatefulWidget {
  const EnAzYorumYapipBegenenlerPage({Key? key}) : super(key: key);

  @override
  State<EnAzYorumYapipBegenenlerPage> createState() => _EnAzYorumYapipBegenenlerPage();
}

class _EnAzYorumYapipBegenenlerPage extends State<EnAzYorumYapipBegenenlerPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("En Az Yorum Yapıp Beğenenler",style: GoogleFonts.roboto(
