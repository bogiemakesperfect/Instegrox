...
class HicEtkilesimdeBulunmayanPage extends StatefulWidget {
  const HicEtkilesimdeBulunmayanPage({Key? key}) : super(key: key);

  @override
  State<HicEtkilesimdeBulunmayanPage> createState() => _HicEtkilesimdeBulunmayanPage();
}

class _HicEtkilesimdeBulunmayanPage extends State<HicEtkilesimdeBulunmayanPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("Hiç Etkileşimde Bulunmayanlar",style: GoogleFonts.roboto(
