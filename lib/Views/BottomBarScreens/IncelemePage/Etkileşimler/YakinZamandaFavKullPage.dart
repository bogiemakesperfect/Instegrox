...
class YakinZamandaFavKullaniciPage extends StatefulWidget {
  const YakinZamandaFavKullaniciPage({Key? key}) : super(key: key);

  @override
  State<YakinZamandaFavKullaniciPage> createState() => _YakinZamandaFavKullaniciPage();
}

class _YakinZamandaFavKullaniciPage extends State<YakinZamandaFavKullaniciPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("Yakın Zamandaki Favori Kullanıcılarım",style: GoogleFonts.roboto(
