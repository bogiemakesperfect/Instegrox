...
class EnCokYorumPage extends StatefulWidget {
  const EnCokYorumPage({Key? key}) : super(key: key);

  @override
  State<EnCokYorumPage> createState() => _EnCokYorumPageState();
}

class _EnCokYorumPageState extends State<EnCokYorumPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("En Çok Yorum Yapanlar",style: GoogleFonts.roboto(
