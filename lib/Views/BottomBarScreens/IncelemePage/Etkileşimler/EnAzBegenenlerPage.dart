...
class EnAzBegenenler extends StatefulWidget {
  const EnAzBegenenler({Key? key}) : super(key: key);

  @override
  State<EnAzBegenenler> createState() => _EnAzBegenenler();
}

class _EnAzBegenenler extends State<EnAzBegenenler> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("En Az Beğenenler",style: GoogleFonts.roboto(
