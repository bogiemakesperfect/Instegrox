...
class EnYakinArkadaslarimPage extends StatefulWidget {
  const EnYakinArkadaslarimPage({Key? key}) : super(key: key);

  @override
  State<EnYakinArkadaslarimPage> createState() => _EnYakinArkadaslarimPage();
}

class _EnYakinArkadaslarimPage extends State<EnYakinArkadaslarimPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("En Yakın Arkadaşlarım",style: GoogleFonts.roboto(
