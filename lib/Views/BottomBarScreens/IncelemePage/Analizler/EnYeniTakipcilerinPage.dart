...
class EnYeniTakipcilerin extends StatefulWidget {
  const EnYeniTakipcilerin({Key? key}) : super(key: key);

  @override
  State<EnYeniTakipcilerin> createState() => _EnYeniTakipcilerin();
}

class _EnYeniTakipcilerin extends State<EnYeniTakipcilerin> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("En Yeni Takipçilerin",style: GoogleFonts.roboto(
