...
class TakibiBirakanKullanicilarPage extends StatefulWidget {
  const TakibiBirakanKullanicilarPage({Key? key}) : super(key: key);

  @override
  State<TakibiBirakanKullanicilarPage> createState() => _TakibiBirakanKullanicilarPage();
}

class _TakibiBirakanKullanicilarPage extends State<TakibiBirakanKullanicilarPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("Takibi Bırakan Kullanıcılar",style: GoogleFonts.roboto(
