...
class TumKaybedilenTakipcilerinPage extends StatefulWidget {
  const TumKaybedilenTakipcilerinPage({Key? key}) : super(key: key);

  @override
  State<TumKaybedilenTakipcilerinPage> createState() => _TumKaybedilenTakipcilerinPage();
}

class _TumKaybedilenTakipcilerinPage extends State<TumKaybedilenTakipcilerinPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("Tüm Kaybedilen Takipçilerin",style: GoogleFonts.roboto(
