...
class GizliHayranlarinPage extends StatefulWidget {
  const GizliHayranlarinPage({Key? key}) : super(key: key);

  @override
  State<GizliHayranlarinPage> createState() => _GizliHayranlarinPage();
}

class _GizliHayranlarinPage extends State<GizliHayranlarinPage> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("Gizli Hayranların",style: GoogleFonts.roboto(
