...
class EnBegenilenGonderilerPage extends StatefulWidget {
  const EnBegenilenGonderilerPage({Key? key}) : super(key: key);

  @override
  State<EnBegenilenGonderilerPage> createState() => _EnBegenilenGonderilerPage();
}

class _EnBegenilenGonderilerPage extends State<EnBegenilenGonderilerPage> {
  ...
  final String AssetKalp = 'assets/images/svgicons/kalpicon.svg';
  @override
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("En Beğenilen Gönderilerin",style: GoogleFonts.roboto(
