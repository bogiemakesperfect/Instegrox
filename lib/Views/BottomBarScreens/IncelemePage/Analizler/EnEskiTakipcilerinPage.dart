...
class EnEskiTakipcilerin extends StatefulWidget {
  const EnEskiTakipcilerin({Key? key}) : super(key: key);

  @override
  State<EnEskiTakipcilerin> createState() => _EnEskiTakipcilerin();
}

class _EnEskiTakipcilerin extends State<EnEskiTakipcilerin> {
            ...
            Container(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text("En Eski Takipçilerin",style: GoogleFonts.roboto(
