...
class GeriBildirimPage extends StatefulWidget {
  const GeriBildirimPage({super.key});

  @override
  State<GeriBildirimPage> createState() => _GeriBildirimPageState();
}

class _GeriBildirimPageState extends State<GeriBildirimPage> {
                      ...
                      height: Adaptive.h(7),
                            ...
                            child: Padding(
                              ...
                              Container(
                                ...
                                child: Text("Geri bildirim gönder",style: GoogleFonts.roboto(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              SvgPicture.asset(
                                'assets/images/svgicons/bildirimver.svg',
                                color: const Color(0xFFACC5DB),
                                width: 21,
                                height: 21,
                              ),
                              const SizedBox(width: 8,),
                              Text("Geri Bildirimde Bulunun",style: GoogleFonts.roboto(
                              textStyle : const TextStyle(fontSize: 17,color: Colors.white,fontWeight: FontWeight.w700,letterSpacing: .0)
                                ),)
                            ],
                          ),
                          Text("Yaşadığınız sorunları aşağıdaki formu \n doldurarak bize kolayca iletebilirsiniz.",style: GoogleFonts.roboto(
                              textStyle : const TextStyle(fontSize: 16,color: Color(0xFF99B1C7),fontWeight: FontWeight.w400,letterSpacing: .0)
                                ),),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                          Text("Mail Adresiniz:",style: GoogleFonts.roboto(
                              textStyle : const TextStyle(fontSize: 15,color: Color(0xFFACC5DB),fontWeight: FontWeight.w700,letterSpacing: .0)
                                ),),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                          Text("Mesajınız:",style: GoogleFonts.roboto(
                              textStyle : const TextStyle(fontSize: 15,color: Color(0xFFACC5DB),fontWeight: FontWeight.w700,letterSpacing: .0)
                                ),),
                                const SizedBox(height: 8,),
                          Container(
                            ...
                            child: const TextField(
                                ...
                                decoration: InputDecoration(
                                  border: InputBorder.none,
                                  hintText: "   Yaşadığınız sorunu belirtin.",
                            ...
                            child: Container(
                              ...
                              child : Row(
                                ...
                                children: [
                                  ...
                                  Text("Gönder",style: GoogleFonts.roboto(
