...
class AboneliklerHakkindaPage extends StatefulWidget {
  const AboneliklerHakkindaPage({super.key});

  @override
  State<AboneliklerHakkindaPage> createState() => _AboneliklerHakkindaPageState();
}

class _AboneliklerHakkindaPageState extends State<AboneliklerHakkindaPage> {
...
//yeni versiyon
                    ...
                    height: Adaptive.h(7),
                          ...
                          child: Padding(
                            ...
                            Container(
                              ...
                              child: Text("Abonelikler hakkında",style: GoogleFonts.roboto(
                ...
                Expanded(
                  child: Container(
                    ...
                    children: [
                      SvgPicture.asset(
                              'assets/images/svgicons/abonelikler.svg',
                              color: const Color(0xFFACC5DB),
                              width: 21,
                              height: 21,
                            ),
                            const SizedBox(width: 8,),
                            Text("Abonelikler Hakkında",style: GoogleFonts.roboto(
