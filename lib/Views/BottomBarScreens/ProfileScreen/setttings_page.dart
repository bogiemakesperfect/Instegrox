                ...
                Padding(
                  ...
                  const SizedBox(height: 24,),
                    ...
                    onTap: (){
                        Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => const KullaniciAramaPageTwo()),
                              
                              );
                    },
                                    child: Container(   // ! kullanıcı arama
                                                      width: screenWidth,
                                                      height: screenWidth * 0.15,
                                                      color: const Color(0xFF11131D).withOpacity(0.81),
                                                      child: ListTile(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const GeriBildirimPage()),
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const SorunBildirPage()));
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const GecmisiSilPage()));
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const KullanimKosullariPage()));
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const GizlilikPolitikasiPage()));
                  ...
                  const SizedBox(height: 24,),
                   InkWell(
                    onTap: () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const AboneliklerHakkindaPage()));
                    },
                     child: Container(
                      width: screenWidth,
                      height: screenWidth * 0.15,
